...
function Footer() {
  return (
    ...
    <div>
        <p className='text-neutral-300 text-xs md:text-sm text-center'>&copy; Harpenin {new Date().getFullYear()} | All rights reserved | <Link className='hover:text-accent hover:underline' target='_blank' to='https://github.com/pranaygoel02'>Pranay Goel</Link></p>
    </div>
    </div>
  )
}
